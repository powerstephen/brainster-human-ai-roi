...
export function RoiCalculator() {
  ...
  // Live results (always compute so the right-rail updates every step)
  const res = useMemo(() => calcHumanRoi(g, maturityParams, prog), [g, maturityParams, prog]);

  // Derived: trained employees & training cost
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-6">
      <div className="space-y-5">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="card p-5 space-y-2">
              ...
              <p className="text-sm text-neutral-700">
                Estimate the <strong>AI Dividend</strong> from upskilling employees — time freed for higher-value work,
                not bot replacement.
              </p>
              <p className="help">
                We only count <em>incremental</em> gains vs. today. All assumptions are editable.
              </p>

              <div className="grid grid-cols-2 gap-3 pt-2">
                <div className="card p-3">
                  <div className="text-xs text-neutral-500">Trained in program</div>
                  <div className="text-lg font-semibold">{trainedEmployees.toLocaleString()}</div>
                </div>
                <div className="card p-3">
                  <div className="text-xs text-neutral-500">Training cost (est.)</div>
                  <div className="text-lg font-semibold">{fmtCurrency(trainingCostTotal)}</div>
                </div>
              </div>
            </div>
          </div>
        ...
        {step === 2 && (
          <div className="card p-5 space-y-4">
            ...
            <p className="help">We attribute only the incremental value beyond this baseline to training.</p>
            <div className="flex gap-2 pt-2">
          ...
          <div className="card p-5 space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <PercentRow
                ...
                min={10}
                max={40}
                hint="Conservative: 15–25%. Upper bound is capped for credibility."
              />
              <NumberRow
              ...
              <NumberRow
                ...
                min={1}
                step={1}
                hint="For planning; ROI is annualized."
              />
            </div>
            <div className="flex gap-2 pt-2">
        ...
        {step === 4 && (
          <div className="space-y-4">
            ...
            <div className="card p-4 space-y-2">
              ...
              <p className="help">
                We cap post-training effective savings at 50% of repetitive time for credibility. High-maturity orgs often
                gain via standardization, QA, and governance rather than raw time cuts.
              </p>
            </div>
            ...
            <div className="card p-4 space-y-3">
              ...
              <p className="text-sm text-neutral-700">
                Start with a focused cohort → document workflows and wins → scale. We can package these inputs and
      ...
      {/* Sticky right-rail: always useful, no filler text */}
      <LiveSummary
        employees={employees}
